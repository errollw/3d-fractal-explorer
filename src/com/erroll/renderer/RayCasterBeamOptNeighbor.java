...
public class RayCasterBeamOptNeighbor extends RayCasterBeamOptRestart {

	// ----------------------------------------------------------------------------------------------------
	// Override the original coarse and fine restart rayCast behavior with neighbor pointer implementation
	// ----------------------------------------------------------------------------------------------------
	@Override
	public double coarseRayCast(RayInterface ray) {
		...
		while (true) {
			...
			// if no neighbor node found return MISSED RAY
			if (neighbor == null)
				return DOUBLE_MAX;
